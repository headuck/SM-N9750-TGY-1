...
public class MobileWipsPacketSender {
    ...
    /* JADX INFO: Multiple debug info for r0v17 byte[]: [D('result_src_mac' byte[]), D('iParams' android.net.util.InterfaceParams)] */
    ...
    /* JADX INFO: Multiple debug info for r2v19 'recvBuf'  byte[]: [D('recvBuf' byte[]), D('sumBuf' java.nio.ByteBuffer)] */
