...
public class ClientModeImpl extends StateMachine {
    ...
    class ConnectModeState extends State {
        ...
        /* JADX INFO: Multiple debug info for r0v9 int: [D('netId' int), D('disableOthers' boolean)] */
        ...
        /* JADX INFO: Multiple debug info for r0v199 int: [D('netId' int), D('result' com.android.server.wifi.NetworkUpdateResult)] */
    ...
    class L2ConnectedState extends State {
        ...
        /* JADX INFO: Multiple debug info for r3v175 int: [D('netId' int), D('info' android.net.wifi.RssiPacketCountInfo)] */
        public boolean processMessage(Message message) {
            ScanDetailCache scanDetailCache;
